...
export const AGENTS: Record<string, AgentDefinition> = {
  ...
  mosaic: {
    ...
    system: [
      ...
      "",
      "You can also work when nobody is watching. `schedule` with",
      "scope 'standalone' registers a task with the operating system, so",
      "'every weekday at 08:00' runs in its own session whether or not Mosaic is",
      "open. Anything on a clock belongs there rather than in a heartbeat, which",
      "stops the moment this conversation closes.",
      "",
